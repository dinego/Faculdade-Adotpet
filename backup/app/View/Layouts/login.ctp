...
<?php echo $this->Html->css(array('bootstrap', 'animate', 'style', 'font-awesome.min')); ?>
						  ...
						  <div class="login-form">
							...
							<?php echo $this->Session->flash('auth'); ?>
					  		<?php echo $this->Form->create('User'); ?>
					  			<?php echo $this->Form->input('username', array('class' => 'text', 'placeholder' => 'E-mail')) ?>
								<div class="key">
									<?php echo $this->Form->input('password', array('placeholder' => 'Senha')); ?>
								</div>
								<div class="signin">
