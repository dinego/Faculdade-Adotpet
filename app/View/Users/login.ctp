      ...
      <div class="container">
        ...
        <div class="top-menu">
          ...
          <nav class="cl-effect-5">
            ...
            <li><?php echo $this->Html->link('Me Cadastrar', array('controller' => 'users', 'action' => 'add'), array('style' => 'background-color: #4278C0; color:#fff; border-bottom: 3px solid #005996; padding-left: 5px; padding-right: 5px')); ?></li>
          </nav>
          </ul>
        </div>
        <!-- script for menu -->
            ...
            <?php echo $this->Form->create('User'); ?>
              <div class="login-form">
                ...
                <div class="head-info">
                  ...
                  <div class="clear"> </div>
                    <?php echo $this->Form->input('username', array('class' => 'text', 'placeholder' => 'E-mail', 'label' => false, 'div' => false)); ?>
                    <div class="key">
                      <?php echo $this->Form->input('password', array('placeholder' => 'Senha', 'label' => false, 'div' => false)) ?>
                    </div>
                    <div class="signin">
